...
type ChainCollectTasks struct {
	...
	ActualAmount         decimal.Decimal `gorm:"column:actual_amount;default:null;unsigned" json:"actual_amount"`
	...
	MaxFeePerGas         decimal.Decimal `gorm:"column:max_fee_per_gas;unsigned;default:null" json:"max_fee_per_gas"`
