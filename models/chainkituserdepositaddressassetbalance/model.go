...
func (data *ChainUserDepositAddressAssetBalance) GetCreateDDL() string {
	return "CREATE TABLE `chain_user_deposit_address_asset_balance` (\n  `id` bigint unsigned NOT NULL AUTO_INCREMENT,\n  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',\n  `chain_db_id` bigint unsigned NOT NULL COMMENT '链ID',\n  `token_id` bigint unsigned NOT NULL COMMENT '代币ID',\n  `user_deposit_address_id` bigint unsigned NOT NULL COMMENT '充值地址ID',\n  `address` char(42) NOT NULL COMMENT '地址',\n  `confirmed_in_amount` decimal(36,0) NOT NULL DEFAULT '0' COMMENT '已确认累计流入',\n  `collected_out_amount` decimal(36,0) NOT NULL DEFAULT '0' COMMENT '已归集累计流出',\n  `manual_out_amount` decimal(36,0) NOT NULL DEFAULT '0' COMMENT '人工转出累计',\n  `balance_amount` decimal(36,0) NOT NULL DEFAULT '0' COMMENT '当前可归集余额',\n  `last_in_tx_hash` char(42) DEFAULT NULL COMMENT '最后一笔流入交易hash',\n  `last_collect_tx_hash` char(42) DEFAULT NULL COMMENT '最后一笔归集交易hash',\n  `created_at` datetime NOT NULL,\n  `updated_at` datetime NOT NULL,\n  PRIMARY KEY (`id`),\n  UNIQUE KEY `uk_addr_token` (`chain_db_id`,`user_deposit_address_id`,`token_id`),\n  KEY `idx_user_id` (`user_id`),\n  KEY `idx_user_address_id` (`user_deposit_address_id`),\n  KEY `idx_tb` (`token_id`,`balance_amount`)\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='充值地址资产余额表';"
}
