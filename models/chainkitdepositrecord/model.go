...
func (data *ChainDepositRecord) GetCreateDDL() string {
	return "CREATE TABLE `chain_deposit_record` (\n  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',\n  `user_id` bigint unsigned NOT NULL COMMENT '用户ID',\n  `chain_db_id` bigint unsigned NOT NULL COMMENT '链配置表ID',\n  `token_id` bigint unsigned NOT NULL COMMENT '代币ID，0可表示原生币',\n  `event_log_id` bigint unsigned NOT NULL COMMENT '事件日志表ID',\n  `user_deposit_address_id` bigint unsigned NOT NULL COMMENT '用户充值地址表ID',\n  `from_address` char(42) NOT NULL COMMENT '付款地址',\n  `to_address` varchar(128) NOT NULL COMMENT '收款地址',\n  `amount` decimal(32,0) NOT NULL COMMENT '原始精度金额，按最小单位保存',\n  `amount_decimal` decimal(32,18) DEFAULT NULL COMMENT '格式化金额，可选，便于查表',\n  `remark` varchar(255) DEFAULT NULL COMMENT '备注',\n  `created_at` datetime NOT NULL COMMENT '创建时间',\n  PRIMARY KEY (`id`),\n  KEY `idx_user_id` (`user_id`),\n  KEY `idx_user_address_id` (`user_deposit_address_id`),\n  KEY `idx_to_address` (`to_address`)\n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='充值记录表';"
}
